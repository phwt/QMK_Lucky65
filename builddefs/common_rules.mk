...
# Jlink Device
JLINK_DEVICE ?= WB32F10x

# Flash using jlink
flash-jlink: $(BUILD_DIR)/$(TARGET).jlink
	@echo JLink.exe -device $(JLINK_DEVICE) -if $(JLINK_IF) -JTAGConf -1,-1 -speed auto -CommandFile $(TARGET).jlink > $(BUILD_DIR)/firmware.bat
...
avrdude-loop usbasp flash-jlink
