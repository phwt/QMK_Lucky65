...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_LB] = LAYOUT( /* Base */
        ...
        KC_LCTL,   KC_LGUI, KC_LALT,                            KC_SPC,KC_SPC,KC_SPC,                         KC_RALT,   MO(_LF), KC_LEFT,   KC_DOWN,    KC_RGHT),

    [ _LF] = LAYOUT( /* Base */
        KC_GRV,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RGB_TOG, KC_VOLU,KC_MUTE,
        TO(_LM),   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB, _______,  _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, RGB_MOD, KC_VOLD,
    RESET_Profile,   _______, _______, _______, _______, _______, KC_SCRL, KC_PAUS, KC_HOME, KC_END,  _______, _______, RGB_HUI,          KC_HOME,
        _______,   _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______,          RGB_VAI, KC_END,
        NUM_TOF1,   Win_Lock, _______,                            IM_BATQ,IM_BATQ,IM_BATQ,                            KC_RCTL, _______, RGB_SPD, RGB_VAD, RGB_SPI),

    [_LS] = LAYOUT( /* Base */
        KC_GRV,    KC_MYCM, KC_MAIL, KC_WHOM, KC_CALC, KC_MSEL, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, RGB_TOG, _______,KC_MUTE,
        TO(_LM),   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB, _______,  _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, RGB_MOD, _______,
    RESET_Profile,   _______, _______, _______, _______, _______, KC_SCRL, KC_PAUS, KC_HOME, KC_END,  _______, _______, RGB_HUI,          KC_HOME,
        _______,   _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______,          RGB_VAI, KC_END,
        NUM_TOF1,   Win_Lock, _______,                            IM_BATQ,IM_BATQ,IM_BATQ,                            KC_RCTL, _______, RGB_SPD, RGB_VAD, RGB_SPI),
    ...
    [_LM] = LAYOUT(  /* Base */
        ...
        KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,    KC_ENT,                KC_PGUP,
        KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,               KC_UP,      KC_PGDN,
        KC_LCTL,   KC_LALT, KC_LGUI,                            KC_SPC,KC_SPC,KC_SPC,                         KC_RALT, MO(_LMF),   KC_LEFT,   KC_DOWN,    KC_RGHT),

    [_LMF] = LAYOUT(  /* FN */
        KC_GRV,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RGB_TOG, KC_VOLU,KC_MUTE,
        TO(_LB),   IM_BT1,  IM_BT2,  IM_BT3,  IM_2G4,  IM_USB, _______,  _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, RGB_MOD, KC_VOLD,
    RESET_Profile,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_HUI,          KC_HOME,
        _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          RGB_VAI, KC_END,
        NUM_TOF1,   _______, _______,                            IM_BATQ,IM_BATQ,IM_BATQ,                            KC_RALT, _______, RGB_SPD, RGB_VAD, RGB_SPI),

    [_LMS] = LAYOUT(  /* FN */
        KC_GRV,    KC_BRIU, KC_BRID, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, RGB_TOG, _______,KC_MUTE,
...
im_lkey_t lkey_define_user[IM_LKEY_COUNT] = {
    ...
    {.keycode = RESET_Profile, .hole_time = 3000}, // 参数：按键值，长按时间
};
#endif
